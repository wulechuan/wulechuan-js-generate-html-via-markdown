...
function 完整流程 {
    ...
    Update-吴乐川更新当前_npm_项目的所有依赖包 \
        --某产品级依赖包之版本配置 "       @wulechuan/meaningful-error-messages   |:|   latest   |:|" \
        --某产品级依赖包之版本配置 "                                      chalk   |:|   ^4       |:|   chalk 不能更新至第 5 或更晚的版本。因为自第 5 版始， chalk 仅支持 ES Module 语法。" \
        --某产品级依赖包之版本配置 "                                   fs-extra   |:|   latest   |:|" \
        --某产品级依赖包之版本配置 "                                markdown-it   |:|   latest   |:|" \
        --某产品级依赖包之版本配置 "                         markdown-it-anchor   |:|   latest   |:|" \
        --某产品级依赖包之版本配置 "                       markdown-it-checkbox   |:|   latest   |:|" \
        --某产品级依赖包之版本配置 "                    markdown-it-highlightjs   |:|   latest   |:|" \
        --某产品级依赖包之版本配置 "                 markdown-it-toc-done-right   |:|   latest   |:|" \
        ...
        --某研发级依赖包之版本配置 "                               plugin-error   |:|   latest   |:|" \
        --某研发级依赖包之版本配置 "                                replace-ext   |:|   latest   |:|" \
        --某研发级依赖包之版本配置 "                                   through2   |:|   latest   |:|" \
        --内容分割记号='|:|' \
        --NPM安装依赖包时须额外带上的参数序列="$NpmArguments" \
        --调试功能之级别 0 \
        --应仅作仿真演练 false
