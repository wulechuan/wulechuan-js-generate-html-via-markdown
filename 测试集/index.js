...
阻塞式将内容写入文件(
    遵循POSIX标准拼接路径(自本NPM包之根文件夹至测试集输出内容之存放文件夹之相对路径, '《社会主义没有辜负中国》（2021年6月7日）.html'),
    本NPM包现成提供的一枚转换器(
        阻塞式读取文件之内容('./测试集/《社会主义没有辜负中国》（2021年6月7日）.md').toString()
    )
)

阻塞式将内容写入文件(
    遵循POSIX标准拼接路径(自本NPM包之根文件夹至测试集输出内容之存放文件夹之相对路径, '《中国没有辜负社会主义》（2021年6月8日）.html'),
    本NPM包现成提供的一枚转换器(
        阻塞式读取文件之内容('./测试集/《中国没有辜负社会主义》（2021年6月8日）.md').toString()
    )
)
